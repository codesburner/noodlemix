...
exports.addTagsByTracklist = function(req, client, callback) {
  var self = this;
  trakker.generate(req.body.tracklist, function(tracks) {
    var trackList = [];

    tracks.forEach(function(track) {
      req.body.keywords = track.title;
      req.body.is_track = true;
      req.body.start_time = track.startTime;
      req.body.end_time = '';

      self.addTag(req, client, function(err, newTrack) {
        if (err) {
          callback(err);
        } else {
